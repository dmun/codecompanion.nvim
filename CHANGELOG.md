...
## [8.10.1](https://github.com/dmun/codecompanion.nvim/compare/v11.9.1...v8.10.1) (2025-02-08)
...
* :sparkles: `CodeCompanionCmd` to write command-line commands ([da52e53](https://github.com/dmun/codecompanion.nvim/commit/da52e53bcc69fb00c28e19edce61f927af2e683d))
* :sparkles: add /fetch slash command ([1389762](https://github.com/dmun/codecompanion.nvim/commit/1389762b54d494fa6f98b099f49b682b7a56ec1d))
* :sparkles: can now do `:CodeCompanionChat &lt;prompt&gt;` ([a13d030](https://github.com/dmun/codecompanion.nvim/commit/a13d030679554af315f9f03e2deed88f37e99bdb))
* :sparkles: improved workflows ([4bc19d1](https://github.com/dmun/codecompanion.nvim/commit/4bc19d10c7b8026be5e943cccd98a1d5b086d5af))
* :sparkles: support `render-markdown.nvim` plugin ([9b137be](https://github.com/dmun/codecompanion.nvim/commit/9b137be7a9c275d865c9b10d5173e0a1f588aa47))
* [#249](https://github.com/dmun/codecompanion.nvim/issues/249) option to turn off prompt library keymaps ([6d585b5](https://github.com/dmun/codecompanion.nvim/commit/6d585b5c136a089eaf9b5afe68393438c0d8e073))
...
* /buffer slash command can select multiple buffers ([e88b703](https://github.com/dmun/codecompanion.nvim/commit/e88b7036a6428ce82b7254b0a2d58ae869635bbd))
* `:CodeCompanion` can now show sub commands ([06d01fa](https://github.com/dmun/codecompanion.nvim/commit/06d01fac5553561f5b450f292462abc501f9fc05))
* `CodeCompanionToggle` becomes `CodeCompanionChat Toggle` ([f694b22](https://github.com/dmun/codecompanion.nvim/commit/f694b22bf5b9cb609ac149e8e0685b76089a9e08))
* **actions:** add telescope as action palette provider ([1721bc1](https://github.com/dmun/codecompanion.nvim/commit/1721bc1154d4114a0cde99501c321abb93ea512d))
* **adapter:** add generic openai compatible adapter ([e5e9d39](https://github.com/dmun/codecompanion.nvim/commit/e5e9d3920131f0b645c4501741f72fd8fcd8847e))
* **adapters:** :sparkles: add xAI ([516e320](https://github.com/dmun/codecompanion.nvim/commit/516e3204f6e9fefb827bad985b7104a2fb82a291))
* **adapters:** ✨ add Azure OpenAI ([#386](https://github.com/dmun/codecompanion.nvim/issues/386)) ([542628d](https://github.com/dmun/codecompanion.nvim/commit/542628dd68e26bbb59699aa48fe98b83a3798999))
* **adapters:** add claude-3-5-sonnet to Copilot ([1121015](https://github.com/dmun/codecompanion.nvim/commit/1121015dbbce25afce88746861edc6fe930b7a9f))
* **adapters:** add Hugging Face adapter ([#527](https://github.com/dmun/codecompanion.nvim/issues/527)) ([48747c4](https://github.com/dmun/codecompanion.nvim/commit/48747c4e36eb0a3f44d6d9e55f8089b9e27cacfc))
* **adapters:** allow for o1 models at some point with improved schema ([601fa72](https://github.com/dmun/codecompanion.nvim/commit/601fa72b09327f57e0703539673ef120ba3f420c))
* **adapters:** global var to allow override ([4535243](https://github.com/dmun/codecompanion.nvim/commit/453524395fb6d5fd6b82e69fe68fd9256a6f5de3))
* **adapters:** make it easier to work with non-streaming endpoints ([4ae9236](https://github.com/dmun/codecompanion.nvim/commit/4ae9236012adf898b588bb8f5c5d882ab86e34b3))
...
* **adapters:** update the new haiku model ([#404](https://github.com/dmun/codecompanion.nvim/issues/404)) ([9b00ed3](https://github.com/dmun/codecompanion.nvim/commit/9b00ed39c11f43fbb829bcbada2f0a7105dfcee6))
* add `:CodeCompanionChat` sub-commands ([98761d6](https://github.com/dmun/codecompanion.nvim/commit/98761d6d30a36d1ab8bd5995ffbc3620d761bbba))
* add language configuration for LLM responses ([#410](https://github.com/dmun/codecompanion.nvim/issues/410)) ([e1a39bb](https://github.com/dmun/codecompanion.nvim/commit/e1a39bb4e19cbda955a0f3caf09b78b798d10c4c))
* add mini pick as provider for action_palette ([#272](https://github.com/dmun/codecompanion.nvim/issues/272)) ([7d02085](https://github.com/dmun/codecompanion.nvim/commit/7d0208511a97dc7e015b145afd2246175aba3f24))
* add native completions ([a1147f8](https://github.com/dmun/codecompanion.nvim/commit/a1147f8133707251603525acf6a87f5c12ef3a70))
* add picker field to prompt resolution ([#275](https://github.com/dmun/codecompanion.nvim/issues/275)) ([1808fd9](https://github.com/dmun/codecompanion.nvim/commit/1808fd9bbbd4cbc1497eb09dc772e29d4d6d19ba))
* add undojoin for inline inserts ([#338](https://github.com/dmun/codecompanion.nvim/issues/338)) ([8c56f8f](https://github.com/dmun/codecompanion.nvim/commit/8c56f8fccadc3cc965d397d250f7b3e3f091266f))
* all adapter handlers now have self as first param ([ec5c353](https://github.com/dmun/codecompanion.nvim/commit/ec5c353e8c6f3d5fa2f4a8325b02e062d7c18352))
* **anthropic:** update to latest anthropic models ([#353](https://github.com/dmun/codecompanion.nvim/issues/353)) ([bdf4acc](https://github.com/dmun/codecompanion.nvim/commit/bdf4acc623316e0f63f1a5d71b0c5bbceeb7263b))
* **anthropic:** update to latest sonnet-3-5 model ([#346](https://github.com/dmun/codecompanion.nvim/issues/346)) ([1d36e27](https://github.com/dmun/codecompanion.nvim/commit/1d36e272a6e0d8ea7a4e940667335320762b6bc6))
* **chat:** :sparkles: `blink.cmp` support ([cb2c93f](https://github.com/dmun/codecompanion.nvim/commit/cb2c93f8a6b0ab0522a814f244b8011a7275ea3b))
* **chat:** :sparkles: can pin buffers and files to requests ([fc8ee3a](https://github.com/dmun/codecompanion.nvim/commit/fc8ee3a085a44d0ef0111be0499f6552d7dbe865))
* **chat:** :sparkles: yank the last code block ([f095b77](https://github.com/dmun/codecompanion.nvim/commit/f095b77f43a6fd4ef014304dee636f78c02faba5))
* **chat:** `yank_code` can now copy current code block and highlight the yank ([a84f826](https://github.com/dmun/codecompanion.nvim/commit/a84f8267c1deca5b81e4974e2190a58fd71c3733))
* **chat:** add `CodeCompanionChatOpened` event ([fdfc640](https://github.com/dmun/codecompanion.nvim/commit/fdfc640f638de7e44580c75882b81cc6dd99b950))
* **chat:** adding to chat initializes buffer if needed ([#567](https://github.com/dmun/codecompanion.nvim/issues/567)) ([8c82ced](https://github.com/dmun/codecompanion.nvim/commit/8c82cedc3d70255ec6ea0fdb348b3e931c435fba))
* **chat:** can delete references ([367eccc](https://github.com/dmun/codecompanion.nvim/commit/367eccc7cc57edcc249bae850ac4ccdf599a060c))
* **chat:** can delete references ([c0b8c25](https://github.com/dmun/codecompanion.nvim/commit/c0b8c2522c20b8369201132a4ce953f3cdf7b5e2))
* **chat:** can toggle system prompt on/off in the chat buffer ([c157329](https://github.com/dmun/codecompanion.nvim/commit/c15732913d695a7def6b99f22210293bb7d58889))
* **chat:** customize split position ([#556](https://github.com/dmun/codecompanion.nvim/issues/556)) ([7374192](https://github.com/dmun/codecompanion.nvim/commit/73741920097f36c762bb8fe1f4de6617389e2d4c))
* **chat:** display references which are shared with the LLM in the UI ([767efee](https://github.com/dmun/codecompanion.nvim/commit/767efee2ff8fd7d84ac9a5ff35bac52eecec5584))
* **chat:** fire event when the model changes in the chat buffer ([2510965](https://github.com/dmun/codecompanion.nvim/commit/251096585038085edfca6a94b4eb9be18808324b))
* **chat:** keymaps can be custom functions ([5f729f9](https://github.com/dmun/codecompanion.nvim/commit/5f729f91a6b6a4025f8e4753d2c2c29810da0149))
* **chat:** tools and variables are now added to references ([a291a05](https://github.com/dmun/codecompanion.nvim/commit/a291a05233f8ecf7b86a163dcd8bd349f319ff43))
...
* **copilot:** now working with o1 models ([7283611](https://github.com/dmun/codecompanion.nvim/commit/72836115615b62065507431b8a9a8523d224f8e4))
* **editor:** streamline system prompt ([1c12cab](https://github.com/dmun/codecompanion.nvim/commit/1c12cabbc8698bfea8b4e9ed5846412521b437db))
...
* **keymaps:** add condition logic ([c4eb21e](https://github.com/dmun/codecompanion.nvim/commit/c4eb21e89ecf466416b75395ac00bf3db83838e7))
* mini_pick can select multiple buffers ([#413](https://github.com/dmun/codecompanion.nvim/issues/413)) ([031a9e9](https://github.com/dmun/codecompanion.nvim/commit/031a9e9d253872308d22c6619fa7e7db62ba7fc7))
* **mini_pick:** allow multi selection in /files ([#444](https://github.com/dmun/codecompanion.nvim/issues/444)) ([68e0610](https://github.com/dmun/codecompanion.nvim/commit/68e0610fa847ad818f621006746ff4a5f911371f))
* **openai:** support for o1 models ([6f98005](https://github.com/dmun/codecompanion.nvim/commit/6f980055b49d1c96af1c63943152147b4f303ab8))
...
* **prompts:** only use staged files for commit messages prompt ([77a4a94](https://github.com/dmun/codecompanion.nvim/commit/77a4a94304122f3943415eacc5a7e359ea40511d))
* **prompts:** system prompt is optional for custom prompts ([90820fc](https://github.com/dmun/codecompanion.nvim/commit/90820fcdb5e6a570dc4f92731fade4d5f716ea02))
* slash command output is now hidden ([dba83b9](https://github.com/dmun/codecompanion.nvim/commit/dba83b9c632d099a6f8acc3cc178f7b51156750f))
...
* **slash_commands:** `help` cmd now prompts user to trim if exceeding max_lines ([33c326a](https://github.com/dmun/codecompanion.nvim/commit/33c326a0d31473ecf3112d783dbcc22afccfb801))
* **slash_commands:** `symbols` can now be from a selected file ([5356829](https://github.com/dmun/codecompanion.nvim/commit/53568298687773f1c0113b873fd8cdd2968208a7))
* **slash_commands:** add a `default` provider ([c938304](https://github.com/dmun/codecompanion.nvim/commit/c938304fd494a0bb29c917de5963230334649a15))
* **slash_commands:** help can now select multiple docs ([57e8e54](https://github.com/dmun/codecompanion.nvim/commit/57e8e54df850749eb98001f52af5bc4f60b79f0e))
* **tools:** :sparkles: add `[@files](https://github.com/files)` tool ([22ebfb8](https://github.com/dmun/codecompanion.nvim/commit/22ebfb8437e833aa6b25d032a0e1833e736d1d06))
* **tools:** :sparkles: Add `cmd_runner` tool ([ff7ad7f](https://github.com/dmun/codecompanion.nvim/commit/ff7ad7f9e18fb9656e8de23bc540988336a7a93c))
* **tools:** :sparkles: much improved `[@editor](https://github.com/editor)` tool ([07fd7c4](https://github.com/dmun/codecompanion.nvim/commit/07fd7c439fd7da4a22d45d64fa65e781a88da2ca))
* **tools:** :sparkles: tools can be stacked to form agents ([ee483b4](https://github.com/dmun/codecompanion.nvim/commit/ee483b4e11d4c4e64a01ca6fb03c07edf6b2e20c))
...
* **tools:** add read option to `[@files](https://github.com/files)` tool ([cb63d59](https://github.com/dmun/codecompanion.nvim/commit/cb63d59fa3ec4a31ebed1a1db00e1b25f8886686))
* use prompt library in chat buffer and better keymap support ([b462c42](https://github.com/dmun/codecompanion.nvim/commit/b462c42281541567f9197e289dbb2d5e6c7ad220))


### Bug Fixes

* [#255](https://github.com/dmun/codecompanion.nvim/issues/255) remove system prompt ([56603af](https://github.com/dmun/codecompanion.nvim/commit/56603af3fdb86d1f38ad93979aedccf5da492bb9))
* [#299](https://github.com/dmun/codecompanion.nvim/issues/299) switching adapters in chat buffer ([bb14105](https://github.com/dmun/codecompanion.nvim/commit/bb14105df0485e40e646185148578a1458553bc0))
* [#322](https://github.com/dmun/codecompanion.nvim/issues/322) `CodeCompanionChat Add` command locking buffer ([e96b6e5](https://github.com/dmun/codecompanion.nvim/commit/e96b6e5df28622e31092f90aa64daff92eef52e8))
* [#336](https://github.com/dmun/codecompanion.nvim/issues/336) use CDATA sections in editor tool XML schemas ([310cb7f](https://github.com/dmun/codecompanion.nvim/commit/310cb7f30babe3e526dfb9bbac09e55a6f80b6c7))
* [#362](https://github.com/dmun/codecompanion.nvim/issues/362) use actual line breaks for new lines ([9938867](https://github.com/dmun/codecompanion.nvim/commit/993886723868b6fe0340d294f2f3d2a7acc6ae26))
* [#423](https://github.com/dmun/codecompanion.nvim/issues/423) diff provider and `before` inline prompt ([f9a54cc](https://github.com/dmun/codecompanion.nvim/commit/f9a54cc28a861770c3b3db787353b24e7fd0cd2d))
* [#427](https://github.com/dmun/codecompanion.nvim/issues/427) long prompts causing issue with curl ([d5bef40](https://github.com/dmun/codecompanion.nvim/commit/d5bef403460908069810726ffe79039d4c69f054))
* [#435](https://github.com/dmun/codecompanion.nvim/issues/435) navigate chat buffers ([5779868](https://github.com/dmun/codecompanion.nvim/commit/5779868e2db9fd056c835f375a57287bf46444f0))
* [#501](https://github.com/dmun/codecompanion.nvim/issues/501) `blink.compat` causing issues with completion menu ([c5065d0](https://github.com/dmun/codecompanion.nvim/commit/c5065d02916d8c1bf5dd3baf9f0dd5e1f017fd57))
* [#542](https://github.com/dmun/codecompanion.nvim/issues/542) use vim.treesitter instead of nvim-treesitter. ([#543](https://github.com/dmun/codecompanion.nvim/issues/543)) ([b741490](https://github.com/dmun/codecompanion.nvim/commit/b741490066c0129554300e493f27767b760ffa16))
* **adapters:** [#528](https://github.com/dmun/codecompanion.nvim/issues/528) Gemini adapter fails if system prompt is removed ([7ca4364](https://github.com/dmun/codecompanion.nvim/commit/7ca43642376d7768a3f2ecea2cd99ae9a792451a))
* **adapters:** [#560](https://github.com/dmun/codecompanion.nvim/issues/560) nil url in openai_compatible adpater ([5cc2693](https://github.com/dmun/codecompanion.nvim/commit/5cc26934b0732dda03d311195e6d3f357e4f4a0c))
* **adapters:** azure_openai deployment model mapping ([907e47a](https://github.com/dmun/codecompanion.nvim/commit/907e47ac490a9ab91be8db820e99be6845e0cdc5))
* **adapters:** further openai_compatible fixes ([a84f6ff](https://github.com/dmun/codecompanion.nvim/commit/a84f6ff4be745bcff7d69af96fdbdae2465a33a2))
* **adapters:** gemini-2.0-flash-exp inline strategy ([#568](https://github.com/dmun/codecompanion.nvim/issues/568)) ([a9faa69](https://github.com/dmun/codecompanion.nvim/commit/a9faa69d3bf8308b78deab97292af2acc57d2f87))
* **adapters:** openai_compatible ([0d1388f](https://github.com/dmun/codecompanion.nvim/commit/0d1388f7409f06e96ef2a7eadfa76c1dcfb74648))
...
* allow register to be customised ([dc98cf2](https://github.com/dmun/codecompanion.nvim/commit/dc98cf2f12129d5dd5300d9b7d323d8ecd8be974))
* always use the default diff in commit prompt ([e8ba37a](https://github.com/dmun/codecompanion.nvim/commit/e8ba37a3d922f890464f66c0b21fab74f2263d31))
* **anthropic:** token count calculation ([d518113](https://github.com/dmun/codecompanion.nvim/commit/d51811389eaed3bb910a297b3fc6273e285d1585))
...
* cancel requests to llm ([3a69421](https://github.com/dmun/codecompanion.nvim/commit/3a694217ec868a8551fb6ec3203b98dad11888c9))
* **chat:** [#447](https://github.com/dmun/codecompanion.nvim/issues/447) moving between windows ([d3e88dd](https://github.com/dmun/codecompanion.nvim/commit/d3e88dd8f66bf746d361c8ba96e862d4e3e4aa0f))
* **chat:** [#450](https://github.com/dmun/codecompanion.nvim/issues/450) no longer remove autocmds ([ca1e4d8](https://github.com/dmun/codecompanion.nvim/commit/ca1e4d837d224fc879e031fcea4613c29fade1c0))
...
* **chat:** can prompt llm with slash commands and no user prompt ([167a786](https://github.com/dmun/codecompanion.nvim/commit/167a786007abf7429d0f54c587dd4e49b7bc36e7))
...
* **chat:** changing model always changes settings ([318f40d](https://github.com/dmun/codecompanion.nvim/commit/318f40d35bb53d663f8f80f26737b69430fe1c55))
* **chat:** clear references table ([7c0f6fb](https://github.com/dmun/codecompanion.nvim/commit/7c0f6fb1687c4499075d02913e308279cfeb1b2a))
* **chat:** display tokens in chat buffer ([de55dd5](https://github.com/dmun/codecompanion.nvim/commit/de55dd5c270e486cebf2d11861da41d816926051))
* **chat:** prevent double adding of references ([953b20d](https://github.com/dmun/codecompanion.nvim/commit/953b20dabf63e4e5c7b30b9d32cd1136291aceb1))
* **chat:** show documentation for blink.cmp ([f41dbab](https://github.com/dmun/codecompanion.nvim/commit/f41dbab850572b290e37e0b52244b8ccb9699870))
* **chat:** slash commands from prompt library not visible ([3376f60](https://github.com/dmun/codecompanion.nvim/commit/3376f6052217737cb936236d9069bd4a63ccbace))
* **client:** [#293](https://github.com/dmun/codecompanion.nvim/issues/293) use vim.schedule for `on_error` calls ([4c6dc82](https://github.com/dmun/codecompanion.nvim/commit/4c6dc826bc96ee48bcc2986cc86d63b8e6aa3fab))
* **cmd:** strategy now respects `vim.g.codecompanion_adapter` ([b629005](https://github.com/dmun/codecompanion.nvim/commit/b629005f0467471b4439192492cea2d49f22d52f))
* **cmd:** users can now change adapters ([ec2e4df](https://github.com/dmun/codecompanion.nvim/commit/ec2e4dfedbaf35fa79f03d9f73c4cf4089425359))
...
* **code_runner:** Ensure code is wrapped in CDATA ([f814137](https://github.com/dmun/codecompanion.nvim/commit/f8141375d3b5c4e3b2d387e62d1754b72b62f517))
...
* **completion:** setting of keymaps ([03fbb0a](https://github.com/dmun/codecompanion.nvim/commit/03fbb0ac20d3a028d9462efe49f3d53b60e92a8a))
* **config:** wrap completion condition in pcall ([d19ae05](https://github.com/dmun/codecompanion.nvim/commit/d19ae05f561a7d3b5d311453285996e84cc925de))
* **copilot:** [#363](https://github.com/dmun/codecompanion.nvim/issues/363) parameters overwritten when stream is true ([1c3449c](https://github.com/dmun/codecompanion.nvim/commit/1c3449cf5b63b8b20bbe13842f047f2a220bf70a))
* **copilot:** make gpt-4o the default again ([28e8ddc](https://github.com/dmun/codecompanion.nvim/commit/28e8ddc97e0044e5f04ddd261ac6fa06da9deca6))
...
* custom tools and slash commands fail to load ([0f2e8de](https://github.com/dmun/codecompanion.nvim/commit/0f2e8de176c5409b7d8587447f2b872cc15b04dd))
* **diff:** diff split window wrongly opened in chat window ([#359](https://github.com/dmun/codecompanion.nvim/issues/359)) ([21801b8](https://github.com/dmun/codecompanion.nvim/commit/21801b88c5abb7c4b4b3e715a897505366a986d4))
* **diff:** is_visible() a nil value in default diff ([8d7a796](https://github.com/dmun/codecompanion.nvim/commit/8d7a7965095925039dbfe34f56b0d72920e67545))
* **gemini:** remove cycle from system prompt ([d6b95bb](https://github.com/dmun/codecompanion.nvim/commit/d6b95bb6cbf074e2e431c6a7f9acdd1af7cc9397))
* **inline:** [#426](https://github.com/dmun/codecompanion.nvim/issues/426) concat of lines ([34beee3](https://github.com/dmun/codecompanion.nvim/commit/34beee3a1f5e97cde61bd906afa9ddd534aeb88c))
* **inline:** [#516](https://github.com/dmun/codecompanion.nvim/issues/516) switching adapters via `vim.g.codecompanion_adapter` ([0d91c08](https://github.com/dmun/codecompanion.nvim/commit/0d91c086b30da050aa0a95dd9e69d16d9d88c587))
* **inline:** [#531](https://github.com/dmun/codecompanion.nvim/issues/531) inline edits in c++ buffers ([73e8ea5](https://github.com/dmun/codecompanion.nvim/commit/73e8ea561e81cce3b9c75d825b8294e0a82fc4e9))
...
* **keymaps:** closing and opening chat buffer ([91a08d7](https://github.com/dmun/codecompanion.nvim/commit/91a08d76d47e16f3779545b1f4267a1eb0be1cb1))
* **keymaps:** completion menu is now `&lt;c-_&gt;` ([24f296b](https://github.com/dmun/codecompanion.nvim/commit/24f296bd2382bc9f50d387b5ac849410d6c2d491))
* mini.pick as action_palette provider ([adeb7c4](https://github.com/dmun/codecompanion.nvim/commit/adeb7c42fb7fb1187c64773a46d5bfee8f85dacf))
* OpenAI-compatible adapter ([#446](https://github.com/dmun/codecompanion.nvim/issues/446)) ([3bfc575](https://github.com/dmun/codecompanion.nvim/commit/3bfc575dd69e43cb1b2d01868f1689d024d3bbe4))
* **openai:** [#458](https://github.com/dmun/codecompanion.nvim/issues/458) handle models being a function ([041193b](https://github.com/dmun/codecompanion.nvim/commit/041193b1b238d7b4980847a24c19c74dcf080029))
...
* **openai:** check for choices ([9eb573e](https://github.com/dmun/codecompanion.nvim/commit/9eb573e80b4c2558ce2f430fa96e82b4eb99c8b5))
* **openai:** streaming should be the default ([0224ff9](https://github.com/dmun/codecompanion.nvim/commit/0224ff91a29279b03a5a1dc7a3fc26a968628767))
* **openai:** support streaming in o1 models ([7c77a82](https://github.com/dmun/codecompanion.nvim/commit/7c77a82b1c726734c6b6022b3f4b657660e37b57))
* opening existing chats from the action palette ([59823c2](https://github.com/dmun/codecompanion.nvim/commit/59823c232da7cbbc8a5fde5edbbf32578bd653b4))
* prompt library conditionals ([#277](https://github.com/dmun/codecompanion.nvim/issues/277)) ([a0518b9](https://github.com/dmun/codecompanion.nvim/commit/a0518b9828a4542bd8a51a572f101fa11a0dcbae))
...
* **slash_commands:** [#408](https://github.com/dmun/codecompanion.nvim/issues/408) no symbols found in file ([aececa0](https://github.com/dmun/codecompanion.nvim/commit/aececa030a05ad86614df3fcb0fae0c40c7bac13))
* **slash_commands:** [#515](https://github.com/dmun/codecompanion.nvim/issues/515) help tags line limit can be customised ([e1b9876](https://github.com/dmun/codecompanion.nvim/commit/e1b9876641e4ea0fa80f78339c260b16b729a21f))
* **slash_commands:** fetch doesn't error on no input ([be9e36c](https://github.com/dmun/codecompanion.nvim/commit/be9e36c217f15ff53b06c9eb2ba7c42de026dc70))
* **slash_commands:** prompt library now works with blink.cmp ([1027f47](https://github.com/dmun/codecompanion.nvim/commit/1027f47c6c583a6b6592ae60a8008d780517792a))
* **slash_commands:** show tracked and untracked files ([a7ad936](https://github.com/dmun/codecompanion.nvim/commit/a7ad936a0b92177aa78be78d7661c3336e0ec7cf))
* **slash_commands:** telescope selection ([6184bd4](https://github.com/dmun/codecompanion.nvim/commit/6184bd4e60d4f301cc5f47416a9a90731eb7f8fb))
* **slash_command:** symbols parsing ([ffbcefb](https://github.com/dmun/codecompanion.nvim/commit/ffbcefbccaf9d59a9c0a56ce55507297c0130658))
* **slash:** use loadfile for user's own commands ([6c349c8](https://github.com/dmun/codecompanion.nvim/commit/6c349c8365d1c7aa59f4bda3edcdb9f35a51d080))
* stop non_llm adapters from appearing in chat buffer ([12f5925](https://github.com/dmun/codecompanion.nvim/commit/12f59259d63504269895723d7bd913fce1bf424d))
* telescope extension can take opts ([423447f](https://github.com/dmun/codecompanion.nvim/commit/423447f225f6cad02696c61b8875d8ee7485c435))
* telescope extension for the action palette ([#267](https://github.com/dmun/codecompanion.nvim/issues/267)) ([bf3722b](https://github.com/dmun/codecompanion.nvim/commit/bf3722b4132036b28308ba220b38e32989e1fee1))
* **tools:** [#467](https://github.com/dmun/codecompanion.nvim/issues/467) reading of files on disk ([034ed9e](https://github.com/dmun/codecompanion.nvim/commit/034ed9eec8f8726cc30f9854d92d6f608e399717))
* **tools:** [#503](https://github.com/dmun/codecompanion.nvim/issues/503) shell redirection ([7023e58](https://github.com/dmun/codecompanion.nvim/commit/7023e58a056cb834cd3620fec6c42de37469109b))
* **tools:** add XML block formatting guidance ([#417](https://github.com/dmun/codecompanion.nvim/issues/417)) ([315da62](https://github.com/dmun/codecompanion.nvim/commit/315da62c789fd9053d5b17ba28bb78364d687d49))
...
* **tools:** editor diff should be cleared on_exit ([b143ee0](https://github.com/dmun/codecompanion.nvim/commit/b143ee0831c59fe2ad3582883c09a24f6659b7b0))
* **tools:** explictly add cwd to `plenary.job` call ([e78006d](https://github.com/dmun/codecompanion.nvim/commit/e78006d5a09f0bc9ec78aab4f2a53a4d6bf40149))
...
* **tools:** rejected cmd tools close properly ([50d0d25](https://github.com/dmun/codecompanion.nvim/commit/50d0d2543ed3115477cfacfd80db0e029857127e))
* **tools:** remove ANSI sequences from all output ([2836849](https://github.com/dmun/codecompanion.nvim/commit/2836849c6e1533fc54d06e88d52354374efc728d))
* **tools:** remove print statement for RAG tool ([0ab3a6a](https://github.com/dmun/codecompanion.nvim/commit/0ab3a6a42d89513c43b98485749c9e68fa5b18f0))
* **tools:** strip ansi from cmd output ([679a9a5](https://github.com/dmun/codecompanion.nvim/commit/679a9a513f61a5d4e622c7506599cad55f35e502))
* type for prompt() [#305](https://github.com/dmun/codecompanion.nvim/issues/305) ([8ca9dfb](https://github.com/dmun/codecompanion.nvim/commit/8ca9dfb46e427a141bfdb7db1a341f342db3f613))
...
* **utils:** [#488](https://github.com/dmun/codecompanion.nvim/issues/488) fix edge cases in visual selection ([84a8e89](https://github.com/dmun/codecompanion.nvim/commit/84a8e8962e9ae20b8357d813dee1ea44a8079605))
...
* **utils:** vim.api being replaced with api.api ([40114d7](https://github.com/dmun/codecompanion.nvim/commit/40114d760af19f2ac21a1c248a34dc4c734acf9f))
* **utils:** visual selection range no longer uses feedkeys ([e981da2](https://github.com/dmun/codecompanion.nvim/commit/e981da23ae0e900a4086e8dcbc0b6abf86b737a9))
* **workflow:** can auto_submit the first prompt ([86f96d5](https://github.com/dmun/codecompanion.nvim/commit/86f96d5419915b0711afbc93d948a3312bfc25b6))
* **workflows:** wrap in `vim.schedule` for performance ([f0f6e26](https://github.com/dmun/codecompanion.nvim/commit/f0f6e260a98c5ffe6ff6257227d1f429a4ecb07c))
...
* release 6.0.0 ([5641236](https://github.com/dmun/codecompanion.nvim/commit/56412362ab568420c7d6e40d09327416608c7de2))
* release 8.10.1 ([1d3de26](https://github.com/dmun/codecompanion.nvim/commit/1d3de2645b8f52c41caf502441a8299934a60dbe))


### Code Refactoring

* **agents:** agents are now in `strategies.chat.agents` ([3f437a6](https://github.com/dmun/codecompanion.nvim/commit/3f437a62d55ad6efe14a4af2ffdc4e474696852a))
* make copilot the default adapter ([a2f11ad](https://github.com/dmun/codecompanion.nvim/commit/a2f11ad64625b705d8cf72e04e2c98885351c713))
* move `use_default_actions` to `display.action_palette.opts` and rename to `show_default_actions` ([1624702](https://github.com/dmun/codecompanion.nvim/commit/16247029282e8e57fa696bdad1ed11ab89dcf5b3))
* move `use_default_prompt_library` to `display.action_palette.opts` and rename to `show_default_prompt_library ([247923b](https://github.com/dmun/codecompanion.nvim/commit/247923be33c765afc0dce4327b82ab1dceb785f8))
* move tools/slash/vars from helpers to strategies.chat ([806ed9c](https://github.com/dmun/codecompanion.nvim/commit/806ed9cf17889347e03752516462e149e03a3ddf))
* Plugin now only supports Neovim 0.10.0 and above ([38297a5](https://github.com/dmun/codecompanion.nvim/commit/38297a5403446978cbb237f0eb4adcb98ed6143a))
* remove `pre_defined_prompts` config option ([8052344](https://github.com/dmun/codecompanion.nvim/commit/80523445ef1ca0cbef113d34b6b4301676dda63c))
* rename variable #editor to #viewport ([1bbc762](https://github.com/dmun/codecompanion.nvim/commit/1bbc76202b7eb09609485d82e882ab04afabc228))
* **tools:** remove `code_runner` tool ([362076b](https://github.com/dmun/codecompanion.nvim/commit/362076b1e10748dd8999f73fbe993fb9a446733f))
